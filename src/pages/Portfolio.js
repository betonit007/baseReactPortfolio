  ...
  return (
    <div id='portfolio' style={{ height: '100vh'}}>
      <div className="portMenu">
        <div className={`${pFilter === 'A' ? 'selected techSelection' : 'techSelection'} `} onClick={() => setPFilter('A')}>All</div>
        <div className={`${pFilter === 'Node' ? 'selected techSelection' : 'techSelection'} `} onClick={() => setPFilter('Node')}>Node.js</div>
